...
def extract_metrics(log_path: Path) -> dict:
    ...
    return {
        ...
        "prediction_rank_pairs_total": summary.get("prediction_rank_pairs_total", float("nan")),
        "prediction_rank_hard_pairs": summary.get("prediction_rank_hard_pairs", float("nan")),
        "prediction_rank_easy_pairs": summary.get("prediction_rank_easy_pairs", float("nan")),
        "prediction_rank_dot_gap_mean": summary.get("prediction_rank_dot_gap_mean", float("nan")),
        "prediction_rank_anchor_loss": summary.get("prediction_rank_anchor_loss", float("nan")),
        ...
        "prediction_rank_struct_frac": summary.get("prediction_rank_struct_frac", float("nan")),
        "prediction_hard_residual_only": summary.get("prediction_hard_residual_only", float("nan")),
        "prediction_hard_margin": summary.get("prediction_hard_margin", float("nan")),
        "prediction_dot_anchor_weight": summary.get("prediction_dot_anchor_weight", float("nan")),
        ...
        "prediction_residual_gate_init": summary.get("prediction_residual_gate_init", float("nan")),
        "prediction_residual_scale": summary.get("prediction_residual_scale", float("nan")),
        "prediction_compact_gate": summary.get("prediction_compact_gate", final_decoder_diag.get("prediction_compact_gate", float("nan"))),
        "prediction_compact_residual_scale": summary.get("prediction_compact_residual_scale", float("nan")),
        "decoded_require_structural_support": summary.get("decoded_require_structural_support", float("nan")),
        "decoded_struct_min_cn": summary.get("decoded_struct_min_cn", float("nan")),
        "decoded_struct_min_ra": summary.get("decoded_struct_min_ra", float("nan")),
        "decoded_struct_min_aa": summary.get("decoded_struct_min_aa", float("nan")),
        "edit_add_pairs_pre_struct": summary.get("edit_add_pairs_pre_struct", float("nan")),
        "edit_struct_supported_add_pairs": summary.get("edit_struct_supported_add_pairs", float("nan")),
...
def main():
    ...
    numeric_cols = [
        ...
        "prediction_rank_pairs_total",
        "prediction_rank_hard_pairs",
        "prediction_rank_easy_pairs",
        "prediction_rank_dot_gap_mean",
        "prediction_rank_anchor_loss",
        "prediction_rank_weight",
        "prediction_bce_weight",
        "prediction_encoder_weight",
        "prediction_hard_residual_only",
        "prediction_hard_margin",
        "prediction_dot_anchor_weight",
        "prediction_gate_l1_weight",
        "prediction_h3_gate_init",
        "prediction_h3_gate",
        "prediction_residual_gate_init",
        "prediction_residual_scale",
        "prediction_compact_gate",
        "prediction_compact_residual_scale",
        "decoded_require_structural_support",
        "decoded_struct_min_cn",
        "decoded_struct_min_ra",
        "decoded_struct_min_aa",
        "edit_add_pairs_pre_struct",
        "edit_struct_supported_add_pairs",
